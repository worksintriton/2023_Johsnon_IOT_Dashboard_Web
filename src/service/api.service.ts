...
export class ApiService {
  ...
  user: any;
    ...
    createUserDetails(enteredData:any){
      ...
      getliftLayoutList(enterliftId:any){
        var obj =  {
      //  "liftId": "L-J7481",
      "liftId":enterliftId ? enterliftId: "L-P2909",
      "limit":50
      //  l-p2909
      }
        return this.http.post<any>("http://smart.johnsonliftsltd.com:3000/api/devicescheduletableschemas/getlist_status_by_liftid",obj)
        .pipe(map(response => {
          return response;
        }));
      }  
